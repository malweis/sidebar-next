...
function Sidebar({ isOpen, toggleSidebar, showButton, onItemClick }) {
  ...
  return (
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="h-8 w-8 cursor-pointer" onClick={handleshowButton}>
      ...
      <nav className="flex-grow">
        <ul className="p-4">
          ...
          >
            ...
            onClick={(event) => toggleDropdown(event, "Element3")} >Elementos <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg> </span>
